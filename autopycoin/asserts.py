...
def is_between(obj_to_compare: Any, lower_limit: Union[int,float],
 upper_limit: Union[int,float], name: str) -> None:
    """
...
def greater_or_equal(obj_to_compare: Any,
 target: Union[int,float], name: str) -> None:
    """
...
def lower_or_equal(obj_to_compare: Any,
 target: Union[int,float], name: str) -> None:
    """
...
def equal_length(list_one: List[Union[int,float]], list_two: List[Union[int,float]], name_one: str, name_two: str):
    """
