...
class WindowGenerator(AutopycoinBaseClass):
    ...
    valid : `dataset`
    test : `dataset`
    data : DataFrame or ndarray or `Tensor`
    ...
    def _make_dataset(
        ...
        Parameters
        ----------
        data : `DataFrame`, ndarray or `Tensor of shape (timestep, variables)`
    ...
    def _split_window(self, feature_tensor: tf.Tensor) -> Tuple[tf.Tensor]:
        ...
        Parameters
        ----------
        feature_tensor : `tensor of shape (Batch_size, timestep, variables)`
